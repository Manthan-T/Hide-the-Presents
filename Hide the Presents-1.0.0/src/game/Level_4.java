...
public class Level_4 extends BasicGameState {
	...
	Object[][] sparksInfo = {
		...
		{(float) (screenSize.getWidth()/2), (float) (screenSize.getHeight()/2), false}
	};
	Object[][] buggyInfo = {
		{0f, 0f, true, true},
	...
	Animation[] sparks = new Animation[3];
	
	Rectangle hitboxes[] = new Rectangle[3];

	public Level_4(int state) {
	}

	public void init(GameContainer container, StateBasedGame game) throws SlickException {
		level3 = new Image("res/levels/Level_4.png");
		...
		music = new Music("res/music/Level_4_music.ogg", true);
	}
